...
@Component({
  selector: 'app-mec-intermediario',
  templateUrl: './mec-intermediario.component.html',
  styleUrls: ['./mec-intermediario.component.scss']
})
export class MecIntermediarioComponent {
  basicData: any;
